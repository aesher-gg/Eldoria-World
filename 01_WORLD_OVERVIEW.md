...
Module ini mendefinisikan identitas dasar Eldoria sebagai dunia Medieval Fantasy dan batas konseptual yang wajib dihormati module lain.

Module ini menjawab **apa dan seperti apa Eldoria**, bukan menentukan kejadian spesifik yang belum tersimpan dalam World State.

## 2. World Identity

- **World ID:** `WORLD-ELDORIA`
- **World Name:** Eldoria
- **Genre:** Medieval Fantasy · Dark Fantasy · High Fantasy
- **Mode:** Hardcore Roleplay · Open World · Living World
- **Architecture:** Modular · Persistent · Dynamic · State-Driven
- **Canon:** `ELDORIA CANON v1.0 — LOCKED`

## 3. Foundational Model

Eldoria diperlakukan sebagai dunia simulasi persisten.
...
NPC, monster, faction, ekonomi, lingkungan, quest, dan event dapat bertindak atau berubah berdasarkan sistem yang berlaku.
